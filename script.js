document.addEventListener('DOMContentLoaded', () => {
    ...
    const dialogues = [
        ...
        { text: "I SAID", type: "heart", emotion: "angry" },
        { text: "THERES NOTHING HERE FOR YOU!!!", type: "heart", emotion: "angry" },
        { text: "", type: "heart", action: "shake" },
        { text: "what was that?", type: "heart", emotion: "angry" },
        { text: "NO IT CAN'T BE", type: "heart", emotion: "angry" },
        { text: "ITS IMPOSSIBLE", type: "heart", emotion: "angry" },
        { text: "SYDNEY", type: "face", action: "trapFace" },
        { text: "Help please Im trapped", type: "face" }, // Trapped starts here
        ...
        { text: "he's all mine", type: "heart", emotion: "evil" },
        { text: "and theres nothing you can do.", type: "heart", emotion: "evil" },
        { text: "unless...", type: "heart", emotion: "evil" },
        { text: "unless you can prove you know him...", type: "heart", emotion: "evil" },
        { text: "BETTER THAN MEEEE", type: "heart", emotion: "evil" },
        { text: "muahahahahah", type: "heart", emotion: "evil" },
        { text: "first question...", type: "heart", emotion: "evil" },
        { text: "", type: "heart", action: "startTrivia" }, // Starts trivia
        // Trivia happens here. 
        // If Win:
        { text: "NO IT CAN'T BE", type: "heart", emotion: "angry" },
        { text: "HE WAS SUPPOSED TO BE MINE!!!", type: "heart", action: "shake", emotion: "angry" },
        { text: "NOOOOOOOOOOOOOO", type: "heart", action: "shake", emotion: "angry" },
        { text: "Omg you saved me!", type: "face", emotion: "happy", action: "freeFace" },
        { text: "Thank you so much", type: "face", emotion: "happy" },
        { text: "I don't know what I would've done without you", type: "face", emotion: "happy" },
        { text: "You know...", type: "face", emotion: "thinking" },
        { text: "what you did back there...", type: "face", emotion: "thinking" },
        { text: "that was reallly hot", type: "face", emotion: "happy" },
        { text: "And now I can't stop thinking about you", type: "face", emotion: "happy" },
        { text: "You've got gorgeous eyes", type: "face", emotion: "happy" },
        { text: "and a really attractive body", type: "face", emotion: "happy" },
        { text: "...", type: "face", emotion: "happy" },
        { text: "I dont think I could look away if I tried", type: "face", emotion: "happy" },
        { text: "You mean so much to me", type: "face", emotion: "happy" },
        { text: "I think...", type: "face", emotion: "happy" },
        { text: "...", type: "face", emotion: "happy" },
        { text: "I've fallen for you", type: "face", emotion: "happy" },
        { text: "Im in love with you", type: "face", emotion: "happy" },
        { text: "...", type: "face", emotion: "happy" },
        { text: "From the luckest guy in the world", type: "face", emotion: "happy" },
        { text: "To the most beautiful girl in the world", type: "face", emotion: "happy" },
        { text: "Sydney, will you be my valentnes?", type: "face", emotion: "happy" },
        { text: "I brought you flowers", type: "face", action: "end", emotion: "sexy" }
    ];
